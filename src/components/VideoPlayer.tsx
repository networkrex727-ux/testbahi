...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({ src, title }) => {
  ...
  const isEmbed = forceEmbed || 
                  ...
                  src.includes('mega.nz') ||
                  src.includes('stream') ||
                  src.includes('player') ||
                  !src.match(/\.(mp4|m3u8|webm|ogg|mov)(\?.*)?$/i);
    ...
    >
      {isEmbed ? (
        ...
        <>
          ...
          {error && (
            <div className="absolute inset-0 bg-zinc-950 flex flex-col items-center justify-center text-center p-6 space-y-4 z-50">
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-500 text-sm max-w-xs mx-auto">
                  The video source could not be loaded. This might be an embed link that needs to be played in an iframe.
                </p>
              </div>
              <button 
